...
/* Print the directory files recursively */
...
/* Print directory files without recursion */
...
/* Print the statistics for the current directory */
...
/* List the current directory. Used when no file path is provided */
void listCurrDir()
{
